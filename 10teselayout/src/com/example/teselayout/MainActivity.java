...
public class MainActivity extends Activity {
    ...
    private void getview() {
        ...
        actionItem = (Button) this.findViewById(R.id.actionitem);
    }
    ...
    private void setview() {
        ...
        actionItem.setOnClickListener(clicklister);
    }
    ...
    private View.OnClickListener clicklister = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            case R.id.notiftest:
                ...
                startActivity(intent);
                break;
            case R.id.actionitem:
                intent.setClass(MainActivity.this, ActionItem.class);
                startActivity(intent);
                break;
