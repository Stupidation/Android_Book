...
public class bookmarkandhistory extends Activity{
	...
	public void loadGridView() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(bookmarkandhistory.this, arrayList, R.layout.gridviewitem,
				new String[] { "itemword" }, new int[] { R.id.TextView01 });
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int which, long arg3) {
				...
				case 0:
					if (myRelativeLayout01.getVisibility() == View.GONE) {
						...
						SimpleCursorAdapter sca = new SimpleCursorAdapter(bookmarkandhistory.this, R.layout.listview01item, bookmarkcursor,
								new String[] { "title", "url" }, new int[] { R.id.TextView01, R.id.TextView02 });
									...
									public void onClick(DialogInterface dialog, int which) {
										if (which == 0) {
											...
											if (URLUtil.isNetworkUrl(markurl)) {
												...
												Toast.makeText(bookmarkandhistory.this, "网址错误！", Toast.LENGTH_LONG).show();
											}
											...
											editBuilder.setPositiveButton("确定", new OnClickListener() {
												...
												public void onClick(DialogInterface dialog, int which) {
													...
													bookmarkcursor = db.query("bookmarktable", new String[] { "_id", "title", "url" },
															null, null, null, null, null);
													SimpleCursorAdapter sca = new SimpleCursorAdapter(bookmarkandhistory.this,
															R.layout.listview01item, bookmarkcursor, new String[] { "title", "url" },
											...
											deleteBuilder.setMultiChoiceItems(new String[] { "删除书签" }, new boolean[] { false },
														...
														public void onClick(DialogInterface dialog, int which, boolean isChecked) {
															if (which == 0) {
																if (isChecked == true) {
																	...
																	// 再进行一遍数据库的查询
																	bookmarkcursor = db.query("bookmarktable", new String[] { "_id",
																			"title", "url" }, null, null, null, null, null);
																	SimpleCursorAdapter sca = new SimpleCursorAdapter(
																			bookmarkandhistory.this, R.layout.listview01item,
																			bookmarkcursor, new String[] { "title", "url" }, new int[] {
				...
				case 1:
					if (myRelativeLayout02.getVisibility() == View.GONE) {
						...
						SimpleCursorAdapter sca = new SimpleCursorAdapter(bookmarkandhistory.this, R.layout.listview02item, cursor,
								new String[] { "url" }, new int[] { R.id.TextView01 });
								...
								builder.setSingleChoiceItems(new String[] { "打开", "删除" }, -1, new OnClickListener() {
									...
									public void onClick(DialogInterface dialog, int which) {
										if (which == 0) {
											...
											// 再次进行数据的查询
											cursor = db.query("history", new String[] { "_id", "title", "url" }, null, null, null, null,
													null);
											SimpleCursorAdapter sca = new SimpleCursorAdapter(bookmarkandhistory.this,
													R.layout.listview02item, cursor, new String[] { "url" }, new int[] { R.id.TextView01 });
											myListView02.setAdapter(sca);
										}
